...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.shortcut_add = QtWidgets.QShortcut(QtGui.QKeySequence('Ctrl+A'), self.centralwidget)
        self.shortcut_add.activated.connect(self.add_button)
        ...
        self.shortcut_delete = QtWidgets.QShortcut(QtGui.QKeySequence('Ctrl+D'), self.centralwidget)
        self.shortcut_delete.activated.connect(lambda: self.delete(self.Profs_tableWidget.currentRow()))
